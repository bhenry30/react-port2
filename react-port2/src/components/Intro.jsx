...
function Intro() {
    return (
        <div className='flex flex-col text-center items-center justify-center pb-6 pt-12'>
            <h1 className='text-4xl mb-2 text-teal-900 dark:text-white md:text-6xl font-bold'>Brandon Henry</h1>
            <p className='text-base mb-3 font-medium md:text-xl'>Web Developer</p>
            <img src='./assets/photos/brandon-black-and-white.jpg' alt="Black and White image of Brandon" className='h-80 rounded-md mb-3 md:h-80' />
